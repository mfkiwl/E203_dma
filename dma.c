/////////////////////////////////////////////////////////////////////////////////////////
// Author: Venci Freeman, copyright 2020
// E-mail: vencifreeman16@sjtu.edu.cn
// School: Shanghai Jiao Tong University
// File Name: dma
// Details: These file has 4 functions: initial, config, status and interrupt functions.
// Release History:
...
void dma_init(void);
uint32_t dma_config(uint32_t srcAddr, uint32_t dCTRddr, uint32_t len);
void dma_CTRrt(void);
...
uint32_t dma_config(uint32_t srcAddr, uint32_t dCTRddr, uint32_t len) {
  ...
  DMA_REG_32(DMA_REG_DST) = dCTRddr;  // 目的地址
